...
export function FolderRow(props: {
  ...
  const [name, setName] = useNestedState("widget", "props/name", "--");
  const [showChildren, setShowChildren] = useNestedState(
    "widget",
    "props/isOpen",
    false
  );
  const [, setIsEditingLabel] = useNestedState(
    "widget",
      ...
      row={() => (
        <tr ref={ref} style={trStyle}>
          ...
          >
            ...
            ></Icon>{" "}
            <Editable
              nestedStateKey="props/isEditingLabel"
              value={name}
              onChange={setName}
            ></Editable>
          </td>
