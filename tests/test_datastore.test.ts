...
describe("Datastore", function () {
    it("Basic access", function () {
        ...
        assert.equal(ds.entry_exist(DatastoreEntryType.Var, "/a/b/c"), true)
        assert.equal(ds.entry_exist(DatastoreEntryType.Var, "/a/b/d"), true)
        assert.equal(ds.entry_exist(DatastoreEntryType.Var, "/a/a/a"), false)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/a"), true)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/a/b"), true)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/a/b/c"), true)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/a/b/c/d"), false)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/a/c"), false)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/b"), false)
        assert.equal(ds.path_valid(DatastoreEntryType.Var, "/"), true)
